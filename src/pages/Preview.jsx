...
function Preview() {
  ...
  return (
    <div className="max-h-screen overflow-auto h-screen w-full relative ">
      ...
      <div className="flex min-h-[500px] gap-[1em] flex-col items-center rounded-3xl md:shadow-2xl min-w-[360px] max-w-md bg-base-100 md:bg-base-200 md:absolute md:top-[50%]  md:left-[50%]  md:translate-x-[-50%]  md:translate-y-[-50%]  md:px-[3.5rem] px-4  py-[3rem]">
        <img
