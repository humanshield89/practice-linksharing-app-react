    ...
    <div className="min-h-screen gap-6 flex flex-col p-1 md:p-4 w-full">
      <header className="p-4 shadow-sm rounded-lg bg-base-200 flex justify-between items-center w-full">
        ...
        <div className="flex gap-2">
          <TopbarButton icon={<LinkIcon />} text="Links" active />
          <TopbarButton icon={<ProfileIcon />} text="Profile details" />
        </div>
      ...
      <main className="flex flex-grow gap-6">
        <div className="bg-base-200 rounded-lg shadow-sm hidden md:flex basis-1/3">
          <PhonePreview />
        </div>
        <div className="bg-base-200 rounded-lg shadow-sm flex-1 flex flex-col md:basis-2/3 p-[1.5em] md:p-[2.5em]">
          ...
          <div className="bg-base-100 mt-4 flex-grow rounded-md py-[2.5em] flex flex-col justify-center items-center gap-4">
            ...
            <h2 className="text-[1.5em] md:text-[2em] font-bold m-auto w-[30rem] text-center">
              Let’s get you started
            </h2>
            <p className="text-secondary w-[30rem] m-auto text-center">
